...
from numberofmethods.numberofmethods import NumberOfMethodsMetric
from sloc.sloc import SourceLinesOfCodeMetric
from faninout.faninout import FanInOutMetric
from modulaity.modularity import LouvainModularityMetric
...
class Configuration:
    def __init__(self, version: str):
        ...
        self._setup_argparse_with_arguments()
    ...
    def _setup_argparse_with_arguments(self) -> None:
        ...
        self.arg_parser = argparse.ArgumentParser(description=f'Welcome to emerge {self.version}.')
    ...
    def parse_args(self) -> None:
        ...
        if not args.yamlconfig:
            self.arg_parser.print_help()
            LOGGER.error(f'no yaml config given')
            return
    ...
    def _check_if_yaml_config_is_valid(self, yaml_config: Dict) -> bool:
        ...
        """
        LOGGER.debug(f'running validity checks agains given config...')
