...
class SwiftParser(AbstractParser, AbstractParsingCore):
    ...
    def generate_file_result_from_analysis(self, analysis, *, file_name: str, file_content: str) -> None:
        ...
        file_result: FileResult = FileResult.create_file_result(analysis, file_name, "", self.parser_name(), LanguageType.SWIFT, scanned_tokens)
