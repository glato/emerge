"""
All unit tests that are related to RustParser.
"""

import unittest
from typing import Dict

from tests.testdata.rust import RUST_TEST_FILES
...
class RustParserTestCase(unittest.TestCase):

    def setUp(self):
        self.example_data = RUST_TEST_FILES
    ...
    def test_generate_file_results(self):
        ...
        for _, result in results.items():
            ...
            self.assertTrue(result.scanned_language == LanguageType.RUST)
