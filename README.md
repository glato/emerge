...
## The current version 0.18.3 supports the following scan types
...
- *Disclaimer*: The current version (0.18.3) is not yet stable, probably still has some 🐞 and is probably not yet suited for productive usage.
